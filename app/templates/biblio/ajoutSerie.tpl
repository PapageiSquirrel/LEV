<div class="container-fluid nopadding row">
			...
			<div class="panel-body row">
				<form>
					...
					<div class="form-group col-xs-4">
						<label>Titre :</label>
						<input type="text" name="text_titre" class="form-control" ng-model="serie.Titre" ng-change="filtrerSeriesExistants()" />
					</div>
					
					<div class="form-group col-xs-8 nopadding">
						<ajout-auteur auteurs="serie.Auteurs" serie="serie">
					...
					<div class="form-group col-xs-12 col-md-12 separation">
						...
						<ajout-edition editions="serie.Editions"></ajout-edition>
					</div>
				</form>
			</div>
	...
	<div class="col-xs-4 col-md-4">
		<div class="panel panel-default" ng-show="seriesProposes.length > 0">
			<div class="panel-heading"><label>Séries deja existants</label></div>
			
			<div class="panel-body">
				<ul class="list-unstyled">
					<li ng-repeat="sp in seriesProposes" class="input-group col-md-12">
